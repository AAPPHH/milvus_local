...
class CLIPImageIndexer:
    def __init__(
        ...
        dim=1024,   # Ensure the embedding dimension is correct for the chosen model (e.g., 1024 for ViT-g/14).
        batch_size=1000,
        host="localhost",
        port="19530"
    ):
        ...
        :param dim: Dimension of OpenCLIP embeddings (e.g., 1024 for ViT-g/14).
    ...
    def _setup_model(self):
        """
        Loads EVA02-E-14-plus model in FP16 precision to reduce memory consumption.
        """
